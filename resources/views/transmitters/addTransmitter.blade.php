...
<div class="card shadow mb-4 border-left-primary">
    ...
    <div class="card-body">
      <p class="text-justify">
        ...
        <span class="font-weight-bold" data-toggle="tooltip" data-placement="bottom" title="Ele se parece com '1111111AAA'">número serial</span>
        gravado na parte inferior da placa. 
      </p>
      <p class="text-justify">
        Em seguida, insira o  
        <span class="font-weight-bold" data-toggle="tooltip" data-placement="bottom" title="Ele se parece com '1111'">código de interface</span>
        fornecido para vincular com seu transmissor.
      </p>
      <p class="text-justify">
